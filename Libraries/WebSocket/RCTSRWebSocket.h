...
- (instancetype)initWithURLRequest:(NSURLRequest *)request protocols:(NSArray<NSString *> *)protocols pingInterval: (NSTimeInterval)pingInterval NS_DESIGNATED_INITIALIZER;
